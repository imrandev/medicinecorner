...
public class MenuFrame2 extends JFrame {
    ...
    public MenuFrame2(Connection mConnect, PreparedStatement pStatement, ResultSet rSet) {
        super("MENU");
        this.conn = mConnect;
        this.pst = pStatement;
        this.rs = rSet;
    ...
    public MenuFrame2(Connection mConnect, PreparedStatement pStatement, ResultSet rSet, boolean disable) {
        super("MENU");
        this.conn = mConnect;
        this.pst = pStatement;
        this.rs = rSet;
    ...
    public static void main(String[] args) {
        ...
        invokeLater(() -> {
            new MenuFrame2().setVisible(true);
        });
    }
    ...
    private void placeComponents(JPanel panel) {
        ...
        medBtn.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                new MedicineList(conn, pst,rs,true).setVisible(true);
                dispose();
            }
        });
        ...
        salBtn.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                new SalesFrame(conn, pst,rs,true).setVisible(true);
                dispose();
            }
        });
