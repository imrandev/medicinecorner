...
public class Medicine_list extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        layout.setVerticalGroup(
            ...
            label.setBounds(10,5,100,50);
        pack();
    }// </editor-fold>//GEN-END:initComponents

    private void list_loaderActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_list_loaderActionPerformed
    ...
    }//GEN-LAST:event_list_loaderActionPerformed
    ...
    private void add_rowsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_add_rowsActionPerformed
        // TODO add your handling code here:
        ...
        JOptionPane.showMessageDialog(null, "Data Saved "+row[5]);
        
        
    }//GEN-LAST:event_add_rowsActionPerformed

   
    private void save_listActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_save_listActionPerformed
        // TODO add your handling code here:
        //add_rowsActionPerformed(java.awt.event.ActionEvent evt);
        int[] indexs = jTable2.getSelectedRows();
        Object[] row = new Object[6];
        DefaultTableModel model2 = (DefaultTableModel) jTable2.getModel();
        /*for(int j=0;j<indexs.length;j++){
            row[0]=model2.getValueAt(indexs[j], 0);
            row[1]=model2.getValueAt(indexs[j], 1);
            row[2]=model2.getValueAt(indexs[j], 2);
            row[3]=model2.getValueAt(indexs[j], 3);
            row[4]=model2.getValueAt(indexs[j], 4);
            row[5]=model2.getValueAt(indexs[j], 5);
        ...
        try{
            ...
            for(int j=0;j<indexs.length;j++){
                ...
                row5=model2.getValueAt(indexs[j], 5).toString();
                ;
            ...
            JOptionPane.showMessageDialog(null, "Data Saved "+row5);
            Sum = Integer.parseInt(row5);
    ...
    private void Summation(int Sum) {
        JOptionPane.showMessageDialog(null, "Data Saved "+Sum);
    }
}
